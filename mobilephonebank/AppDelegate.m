...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    UINavigationController * homePageChannel = [[UINavigationController alloc] initWithRootViewController:homePageRootController];
    ...
    UINavigationController * referenceChannel = [[UINavigationController alloc] initWithRootViewController:referenceRootController];
    ...
    UINavigationController * financingChannel = [[UINavigationController alloc] initWithRootViewController:financingRootController];
    ...
    UINavigationController * lifeChannel = [[UINavigationController alloc] initWithRootViewController:lifeRootController];
    ...
    UINavigationController * myChannel = [[UINavigationController alloc] initWithRootViewController:myRootController];
